...
use BlackRook\TaskBundle\Entity\Tag;
use BlackRook\TaskBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BlackRookTaskBundle:Tag')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BlackRookTaskBundle:Tag')->find($id);
     ...
     * @Method("post")
     * @Template("BlackRookTaskBundle:Tag:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("BlackRookTaskBundle:Tag:edit.html.twig")
     */
